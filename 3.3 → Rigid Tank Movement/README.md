...
A demonstration of tank-like movement where the vehicle will accelerate in the direction it is facing, [`rather than`](https://godotengine.org/qa/110889/cannot-get-tank-control-system-to-work) where the player points.
